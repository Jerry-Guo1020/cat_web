  ...
  <div class="contanier">
    <div class="login-main">
      ...
      <form class="form" @submit.prevent="handleRegister">
        ...
        <input type="text" class="input-username" v-model="username" placeholder="请输入用户名" />

        <div class="input-label">密码</div>
        <input type="password" class="input-password" v-model="password" placeholder="请输入密码" />

        <div class="input-label">确认密码</div>
        <input type="password" class="input-password" v-model="confirmPassword" placeholder="请确认密码" />
      ...
      <div class="bottom-links">
        <span class="left" @click="onLogin">已有账号？登录</span>
      </div>
    </div>
...
function handleRegister() {
  ...
  alert(`注册：+${areaCode.value} ${phone.value} / ${username.value} / ${password.value}`)
}
